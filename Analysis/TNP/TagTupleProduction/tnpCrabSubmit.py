...
submitVersion= '21Jul22'

defaultArgs   = ['doEleID=True','doPhoID=True','doTrigger=True']
mainOutputDir = '/store/user/bbarton/TrigEffStudies/TNP_TagTuples'
...
#
os.system('source /cvmfs/cms.cern.ch/common/crab-setup.sh') #Get access to CRAB utilities
from CRABClient.UserUtilities import config
config = config()

config.General.requestName             = ''
config.General.transferLogs            = False
config.General.workArea                = 'crab_projects/crab_%s' % submitVersion
...
def getLumiMask(era):
  ...
  elif era=='UL2016preVFP': return 'Cert_271036-284044_13TeV_Legacy2016_Collisions16_JSON.txt'
  elif era=='UL2016postVFP': return 'Cert_271036-284044_13TeV_Legacy2016_Collisions16_JSON.txt'
  elif era=='UL2017': return 'Cert_294927-306462_13TeV_UL2017_Collisions17_GoldenJSON.txt'
  elif era=='UL2018': return 'Cert_314472-325175_13TeV_Legacy2018_Collisions18_JSON.txt'
