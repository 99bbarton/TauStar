...
## ------------------------------------------------------------------------------
#TNP_CONFIG=myPhoConfig2015.py
#MAIN_DIR=2015/PhoID/FineBins/PassElVeto/OneHighBin/AbsEta/

#TNP_CONFIG=myPhoConfig2015_courseBins.py
#MAIN_DIR=2015/PhoID/CourseBins/PassElVeto/OneHighBin/AbsEta/

#TNP_CONFIG=myPhoConfig2015_pV.py
#MAIN_DIR=2015/PhoID/FineBins/PixelVeto/OneHighBin/AbsEta/

#TNP_CONFIG=myPhoConfig2015_courseBins_pV.py
#MAIN_DIR=2015/PhoID/CourseBins/PixelVeto/OneHighBin/AbsEta/

#TNP_CONFIG=myPhoConfig2015_noVeto.py
#MAIN_DIR=2015/PhoID/FineBins/NoVeto/HighBin/

TNP_CONFIG=myPhoConfig2015_courseBins_noVeto.py
MAIN_DIR=2015/PhoID/CourseBins/NoVeto/HighBin/

#TNP_CONFIG=myPhoConfig2015_stat.py
#MAIN_DIR=2015/PhoID/StatBins/
