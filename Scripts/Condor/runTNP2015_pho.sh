...
MAIN_DIR=2015/PhoID/FineBins/PassElVeto/

#$TNP_CONFIG=myPhoConfig2015_courseBins.py
#MAIN_DIR=2015/PhoID/CourseBins/PassElVeto/

#$TNP_CONFIG=myPhoConfig2015_pV.py
#MAIN_DIR=2015/PhoID/FineBins/PixelVeto/

#$TNP_CONFIG=myPhoConfig2015_courseBins_pV.py
#MAIN_DIR=2015/PhoID/CourseBins/PixelVeto/
