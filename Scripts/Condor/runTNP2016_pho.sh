...
MAIN_DIR=2016/PhoID/FineBins/PassElVeto/

#$TNP_CONFIG=myPhoConfig2016_courseBins.py
#MAIN_DIR=2016/PhoID/CourseBins/PassElVeto/

#$TNP_CONFIG=myPhoConfig2016_pV.py
#MAIN_DIR=2016/PhoID/FineBins/PixelVeto/

#$TNP_CONFIG=myPhoConfig2016_courseBins_pV.py
#MAIN_DIR=2016/PhoID/CourseBins/PixelVeto/
