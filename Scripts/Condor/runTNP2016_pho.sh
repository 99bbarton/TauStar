...
## ------------------------------------------------------------------------------
#TNP_CONFIG=myPhoConfig2016.py
#MAIN_DIR=2016/PhoID/FineBins/PassElVeto/OneHighBin/AbsEta/

#TNP_CONFIG=myPhoConfig2016_courseBins.py
#MAIN_DIR=2016/PhoID/CourseBins/PassElVeto/OneHighBin/AbsEta/

#TNP_CONFIG=myPhoConfig2016_pV.py
#MAIN_DIR=2016/PhoID/FineBins/PixelVeto/OneHighBin/AbsEta/

#TNP_CONFIG=myPhoConfig2016_courseBins_pV.py
#MAIN_DIR=2016/PhoID/CourseBins/PixelVeto/OneHighBin/AbsEta/

#TNP_CONFIG=myPhoConfig2016_noVeto.py
#MAIN_DIR=2016/PhoID/FineBins/NoVeto/HighBin/

TNP_CONFIG=myPhoConfig2016_courseBins_noVeto.py
MAIN_DIR=2016/PhoID/CourseBins/NoVeto/HighBin/

#TNP_CONFIG=myPhoConfig2016_stat.py
#MAIN_DIR=2016/PhoID/StatBins/
