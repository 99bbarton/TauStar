...
## ------------------------------------------------------------------------------
#TNP_CONFIG=myPhoConfig2018.py
#MAIN_DIR=2018/PhoID/FineBins/PassElVeto/OneHighBin/AbsEta/

#TNP_CONFIG=myPhoConfig2018_courseBins.py
#MAIN_DIR=2018/PhoID/CourseBins/PassElVeto/OneHighBin/AbsEta/

#TNP_CONFIG=myPhoConfig2018_pV.py
#MAIN_DIR=2018/PhoID/FineBins/PixelVeto/OneHighBin/AbsEta/

#TNP_CONFIG=myPhoConfig2018_courseBins_pV.py
#MAIN_DIR=2018/PhoID/CourseBins/PixelVeto/OneHighBin/AbsEta/

#TNP_CONFIG=myPhoConfig2018_noVeto.py
#MAIN_DIR=2018/PhoID/FineBins/NoVeto/HighBin/

TNP_CONFIG=myPhoConfig2018_courseBins_noVeto.py
MAIN_DIR=2018/PhoID/CourseBins/NoVeto/HighBin/

#TNP_CONFIG=myPhoConfig2018_stat.py
#MAIN_DIR=2018/PhoID/StatBins/
