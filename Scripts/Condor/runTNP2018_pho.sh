...
MAIN_DIR=2018/PhoID/FineBins/PassElVeto/

#$TNP_CONFIG=myPhoConfig2018_courseBins.py
#MAIN_DIR=2018/PhoID/CourseBins/PassElVeto/

#$TNP_CONFIG=myPhoConfig2018_pV.py
#MAIN_DIR=2018/PhoID/FineBins/PixelVeto/

#$TNP_CONFIG=myPhoConfig2018_courseBins_pV.py
#MAIN_DIR=2018/PhoID/CourseBins/PixelVeto/
